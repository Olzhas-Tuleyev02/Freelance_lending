      ...
      <div className="container mx-auto px-6 text-center z-10">
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Освойте создание сайтов, ботов и даже собственных нейросетей. Мы доведем вас до первого заказа, или вернем полную стоимость обучения.
          </p>
          ...
          <div className="mt-6 flex items-center justify-center space-x-2 text-gray-400">
            ...
            <span>Ваш результат гарантирован договором.</span>
          </div>
        </div>
      </div>
    </section>
